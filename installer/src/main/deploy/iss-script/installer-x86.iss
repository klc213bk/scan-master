...
[Files]
Source: "..\dist\launcher\x86\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
;Source: "..\dist\launcher\x86\ScanApp.l4j.ini"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\launcher\x86\{#MyAppExecName}"; DestDir: "{app}"; Flags: ignoreversion
;Source: "..\dist\launcher\x86\ScanAppc.l4j.ini"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\java\x86\jre\*"; DestDir: "{app}\jre"; Flags: ignoreversion recursesubdirs createallsubdirs
